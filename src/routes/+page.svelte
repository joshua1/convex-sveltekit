...
<article>
  ...
  <header>
    ...
    <nav>
      <a href="/demo/server" class="btn-primary">Live demo</a>
...
&lt;/form&gt;</code
  ...
  <section id="demo">
    <h2>Live demos</h2>
    <p>Real Convex backend. Data resets every 5 minutes.</p>
    <div class="demo-cards">
      <a href="/demo/server" class="demo-card" data-accent>
        <h3>Server-side</h3>
        <code>convexLoad()</code>
        <p>SSR in load function, auto-upgrades to live WebSocket.</p>
      </a>
      <a href="/demo/client" class="demo-card">
        <h3>Client-side</h3>
        <code>convexQuery()</code>
        <p>Live query via WebSocket. Loading state on mount.</p>
      </a>
      <a href="/demo/auth" class="demo-card">
        <h3>Auth</h3>
        <code>Better Auth</code>
        <p>Sign in, profile, SSR-to-live user data.</p>
      </a>
    </div>
  </section>
